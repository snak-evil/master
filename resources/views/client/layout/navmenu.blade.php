<noscript>
      &lt;iframe src="//www.googletagmanager.com/ns.html?id=GTM-T4DJFPZ" height="0" width="0" style="display: none; visibility: hidden;"&gt;&lt;/iframe&gt;
    </noscript>
      ...
      <div class="topbar-column"><a class="hidden-md-down" href="#"><i class="icon-download"></i>&nbsp; Get mobile app</a>
        <div class="lang-currency-switcher-wrap">
          ...
          <div class="dropdown-menu">
            ...
            </div><a class="dropdown-item" href="#"><img src="http://themes.rokaux.com/unishop/v1.4/flags/FR.png" alt="Français">Français</a><a class="dropdown-item" href="#"><img src="http://themes.rokaux.com/unishop/v1.4/img/flags/DE.png" alt="Deutsch">Deutsch</a><a class="dropdown-item" href="#"><img src="http://themes.rokaux.com/unishop/v1.4/img/flags/IT.png" alt="Italiano">Italiano</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <nav class="site-menu">
        <ul>
          <li class="has-megamenu active"><a href="index.html"><span>Home</span></a>
            <ul class="mega-menu">
              <li><a class="d-block img-thumbnail text-center navi-link" href="index.html"><img alt="Featured Products Slider" src="http://themes.rokaux.com/unishop/v1.4/img/mega-menu-home/01.jpg">
                  <h6 class="mt-3">Featured Products Slider</h6></a></li>
              <li><a class="d-block img-thumbnail text-center navi-link" href="home-featured-categories.html"><img alt="Featured Categories" src="http://themes.rokaux.com/unishop/v1.4/img/mega-menu-home/02.jpg">
                  <h6 class="mt-3">Featured Categories</h6></a></li>
              <li><a class="d-block img-thumbnail text-center navi-link" href="home-collection-showcase.html"><img alt="Products Collection Showcase" src="http://themes.rokaux.com/unishop/v1.4/img/mega-menu-home/03.jpg">
                  <h6 class="mt-3">Products Collection Showcase</h6></a></li>
              <li>
                <div class="img-thumbnail text-center"><img alt="More To Come. Stay Tuned!" src="http://themes.rokaux.com/unishop/v1.4/img/mega-menu-home/04.jpg">
          ...
          <li class="has-megamenu"><a href="#"><span>Mega Menu</span></a>
            <ul class="mega-menu">
              ...
              <li>
                <section class="promo-box" style="background-image: url(http://themes.rokaux.com/unishop/v1.4/img/banners/02.jpg);"><span class="overlay-dark" style="opacity: .4;"></span>
              ...
              <li>
                <section class="promo-box" style="background-image: url(http://themes.rokaux.com/unishop/v1.4/img/banners/03.jpg);">
          ...
          <div class="tools">
            ...
            <div class="account"><a href="account-orders.html"></a><i class="icon-head"></i>
              <ul class="toolbar-dropdown">
                <li class="sub-menu-user">
                  <div class="user-ava"><img src="http://themes.rokaux.com/unishop/v1.4/img/account/user-ava-sm.jpg" alt="Daniel Adams">
                  </div>
                  <div class="user-info">
            ...
            <div class="cart"><a href="cart.html"></a><i class="icon-bag"></i><span class="count">3</span><span class="subtotal">$289.68</span>
              <div class="toolbar-dropdown">
                <div class="dropdown-product-item"><span class="dropdown-product-remove"><i class="icon-cross"></i></span><a class="dropdown-product-thumb" href="shop-single.html"><img src="http://themes.rokaux.com/unishop/v1.4/img/cart-dropdown/01.jpg" alt="Product"></a>
                ...
                <div class="dropdown-product-item"><span class="dropdown-product-remove"><i class="icon-cross"></i></span><a class="dropdown-product-thumb" href="shop-single.html"><img src="http://themes.rokaux.com/unishop/v1.4/img/cart-dropdown/02.jpg" alt="Product"></a>
                ...
                <div class="dropdown-product-item"><span class="dropdown-product-remove"><i class="icon-cross"></i></span><a class="dropdown-product-thumb" href="shop-single.html"><img src="http://themes.rokaux.com/unishop/v1.4/img/cart-dropdown/03.jpg" alt="Product"></a>
